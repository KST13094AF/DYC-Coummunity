			...
			<div class="container-fluid" style="padding: 0rem">
				<div class="row page-titles mx-0" style="margin: 0rem">
					<div class="col p-md-0">
						<ol class="breadcrumb">
							<c:if test="${param.depart != null}">
								<li class="breadcrumb-item">${param.depart}</li>
							</c:if>
							<li class="breadcrumb-item active">${param.major}</li>
							<li class="breadcrumb-item active"><b>글쓰기</b></li>
						</ol>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
                            <div class="card-body">
                            <h4 class="card-title m-b-40"><b>주의 사항</b></h4>
					...
					<div class="form-input-content">
						<div class="card">
							<div class="card-body pt-5">
								<h3 class="text-center" style="margin-bottom:2.5rem"><b>${param.major}</b></h3>
								<div class="basic-form">
									<form action="writeAction.do?major=${param.major}" method="post">
										...
										<div class="form-group">
											<label>제목:</label> <input size="30" name="title" type="text" class="form-control" required>
										</div>
										<div class="form-group">
											<label>내용: *이미지는 10mb미만 한개만 가능합니다.*</label>
											<textarea name="content" class="summernote" rows="15" id="comment" required></textarea>
										</div>
										<br>
										<div class="form-group text-right">
											<input type="reset" class="btn mb-1 btn-outline-secondary" value="초기화 하기" style="width:8rem">
											<input type="submit" class="btn mb-1 btn-outline-success" value="글작성" style="width:8rem">
										</div>
									</form>
								</div>
							</div>
